        ...
        <div class="adm_table">
          <div class="add_admin">
            ...
            <form action="edit_user.php" method="POST">
              ...
              <p><input type="text" name="edit_login" value="<?= $edit_login ?>"></p>
              <p><input type="text"  name="edit_password" value="<?= $edit_password ?>"></p>
              <p><input type="submit" value="save" class="add_btn" name="edit_user"></p>
           </form>
          </div>
        </div>
    </div>
