        ...
        <div class="adm_table">
          <div class="add_admin">
            ...
            <form action="edit_ctg.php" method="POST">
              <p><input type="hidden"  name="edit_ctg_id" value="<?=$id?>"></p>
              <p><input type="text"  name="edit_ctg_name" value="<?=$ctg_name?>"></p>
              <p><input type="submit" value="add" class="add_btn" name="edit_ctg"></p>
           </form>
          </div>
        </div>
    </div>
