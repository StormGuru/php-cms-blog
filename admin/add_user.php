        ...
        <div class="adm_table">
          <div class="add_admin">
            ...
            <form action="add_user.php" method="POST">
              <p><input type="text" placeholder="login" name="add_login"></p>
              <p><input type="text" placeholder="password" name="add_password"></p>
              <p><input type="submit" value="add" class="add_btn" name="add_user"></p>
           </form>
          </div>
        </div>
    </div>
